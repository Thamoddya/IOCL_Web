                            ...
                            <div class="col-12 rounded rounded-3">
                                <div class="row rounded rounded-3">
                                    <div
                                        ...
                                        <img src="{{asset('assets/images/BG/courasol1.jpg')}}"
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <p style="font-weight: 700; margin: 0;line-height: 1">
                                                                Thamoddya Rashmitha</p>
                                                            <p style="font-weight: 400; margin: 0;line-height: 1;color: #0a3622">
                                                                Development</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mt-3">
                                                        <p class="p-0 py-1 m-0"
                                                           style="color: #0f5132;font-size: 1.2rem;font-weight: 700;font-family:'SF Pro Display' ">
                                                            Web Development with PHP</p>
                                                        <p class="p-0 py-1 m-0"
                                                           style="color: #093B3B;font-size: 1rem;font-weight: 400;font-family:'SF Pro Display';line-height: 1">
                                                            We provide you the best courses to help you to achieve your
                                                            goals.</p>
                                                    </div>
                                                </div>
                                            </div>
